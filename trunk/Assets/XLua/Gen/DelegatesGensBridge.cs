...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp11(UnityEngine.Vector3 p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(LuaBehaviour.Vector3Param))
			{
			    return new LuaBehaviour.Vector3Param(__Gen_Delegate_Imp5);
			}
		    ...
		    if (type == typeof(LuaBehaviour.Vector3ParamNoRet))
			{
			    return new LuaBehaviour.Vector3ParamNoRet(__Gen_Delegate_Imp11);
			}
